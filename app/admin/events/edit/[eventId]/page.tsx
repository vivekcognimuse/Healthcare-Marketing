...
import { getEvent, updateEvent } from "@/lib/firebase/db-queries";
import { Calendar, Clock, MapPin, Globe, DollarSign, Users, CheckCircle, Edit, ArrowLeft, FileText } from "lucide-react";
        ...
        <div className="min-h-screen bg-white flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="typography-p2 text-black/60">
              {authLoading ? "Verifying authentication..." : "Loading event..."}
            </p>
          </div>
        </div>
        <Footer />
        ...
        <div className="container max-w-5xl mx-auto relative z-10">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="typography-h1 text-black">Edit Event</h1>
