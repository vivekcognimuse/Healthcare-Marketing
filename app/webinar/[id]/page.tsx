...
export default function WebinarPage() {
  ...
  const shareEvent = (platform: 'linkedin' | 'whatsapp' | 'twitter' | 'copy') => {
    ...
    const text = `Check out this webinar: ${event.title}`;
              ...
              <div className="relative bg-gradient-to-br from-[#0F3B7C] to-[#1B5FD4] rounded-2xl shadow-2xl overflow-hidden">
                ...
                {event.imageUrl && (
                  <div className="relative h-48 overflow-hidden bg-gradient-to-br from-white/10 to-white/5">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#0F3B7C] to-transparent"></div>
                  </div>
                )}
                ...
                <div className="p-6 space-y-6">
                  ...
                  {/* CTA Button */}
                  <Link
                    href={`/webinar/${event.id}/register`}
                  ...
                  {event.whatsappLink && (
                    <a
                      ...
                      className="block w-full"
                    >
                      <button className="w-full bg-white/10 hover:bg-white/20 border border-white/30 text-white font-medium py-3 px-6 rounded-xl transition-all touch-manipulation flex items-center justify-center gap-2">
        ...
        >
          ...
          >
            <div className="text-center mb-6 sm:mb-8">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Share This Webinar</h3>
